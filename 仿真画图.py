...
def plot_circle(center,r):
    ...
    x=[center[0]+r*np.cos(i) for i in theta ]
    y = [center[1] + r * np.sin(i) for i in theta]
    plt.plot(x,y,ls='--')
...
plot_circle(UAVs_msg[0][0:2],UAVs_msg[0][5])
plot_circle(UAVs_msg[1][0:2], UAVs_msg[1][5])
plot_circle(UAVs_msg[3][0:2], UAVs_msg[3][5])
plt.show()
