...
UAVs_msg = [[10, 10, 160, 15, 100, 300, [1, 2, 3], 6],
            ...
            [128, -900, 145, 15, 130, 300, [2, 1, 1], 1],
            [180, -900, 145, 15, 130, 300, [2, 1, 1], 1],
            [-800, -900, 45, 15, 130, 300, [2, 1, 1], 1],

            [-780, -900, 145, 15, 130, 300, [2, 1, 1], 1],
            [850, -900, 145, 15, 130, 300, [2, 1, 1], 1],
            [820, -900, 145, 15, 130, 300, [2, 1, 1], 1],
            [810, -900, 145, 15, 130, 300, [2, 1, 1], 1],
            [-800, -900, 45, 15, 130, 300, [2, 1, 1], 1],
